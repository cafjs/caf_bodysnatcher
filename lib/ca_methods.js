...
exports.methods = {
    ...
    resetCalibration: function(cb) {
        ...
        $$.toAdmin.set('calibration', this.state.calibration);
        this.getState(cb);
    },
    ...
    calibrate: function(cb) {
        ...
        //allow time for showing checkerboard
        bundle.calibrate(1000, [this.state.nonce]);
    ...
    handleListener: function(topic, request, from, cb) {
